...
int main(void)
{
  ...
  MX_BlueNRG_2_Init();
  /* USER CODE BEGIN 2 */
	CUSTOM_HYBRID_SENSOR_Init(0, HYBRID_GYRO | HYBRID_PRESSURE);
  /* USER CODE END 2 */
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, CS_BLE_Pin|LED_RED_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, CS_T_Pin|CS_R_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : CS_BLE_Pin LED_RED_Pin */
  GPIO_InitStruct.Pin = CS_BLE_Pin|LED_RED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pin : IRQ_BLE_Pin */
  ...
  /*Configure GPIO pins : CS_T_Pin CS_R_Pin */
  GPIO_InitStruct.Pin = CS_T_Pin|CS_R_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
